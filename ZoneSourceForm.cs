...
namespace LauncherCS
{
  public class ZoneSourceForm : Form
  {
    ...
    private void LauncherZoneSourceForm_Load(object sender, EventArgs e)
    {
      ...
      string str1 = Path.Combine(Launcher.GetModDirectory(text), "mod.csv");
      string str2 = Path.Combine(Launcher.GetModDirectory(text), "missingasset.csv");
    ...
    private void ZoneSourceBottomSaveButton_Click(object sender, EventArgs e) => this.SaveCSV();

    private void ZoneSourceSaveCSVMenuItem_Click(object sender, EventArgs e) => this.SaveCSV();
  }
}
