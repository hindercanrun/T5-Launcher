...
namespace Launcher
{
  public class LightOptionsForm : Form
  {
    ...
    private void LightOptionsForm_Load(object sender, EventArgs e)
    {
      ...
      this.LightOptionsHDRCheckBox.Checked = Launcher.mapSettings.GetBoolean("lightoptions_hdr");
      ...
      this.LightOptionsLGICheckBox.Checked = Launcher.mapSettings.GetBoolean("lightoptions_lgi");
